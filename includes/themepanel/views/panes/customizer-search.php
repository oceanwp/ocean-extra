...
<div id="ocean-customizer-search" class="column-wrap clr">
	<label for="oceanwp-switch-customizer-search" class="oceanwp-tp-switcher column-name clr">
		<input type="checkbox" name="oe_panels_settings[customizer-search]" value="true" id="oceanwp-switch-customizer-search" <?php checked( (bool) Ocean_Extra_New_Theme_Panel::get_setting( 'customizer-search' ) ); ?>>
