...
class Ocean_Extenstion_Panel {
	...
	const EXT_URL = 'https://demos.oceanwp.org/ext-pack/extensions/extensions.json';
	...
	public function add_menu_page() {
		add_submenu_page(
			'oceanwp',
			esc_html__( 'Ocean Extension Panel', 'ocean-extra' ),
			esc_html__( 'Ocean Extensions', 'ocean-extra' ),
			'install_plugins',
			'ocean-ext-panel',
