...
if ( class_exists( 'WP_Importer' ) ) {
    ...
    class Ocean_WP_Import extends WP_Importer {
        ...
        public function import_start( $file ) {
            if ( ! is_file( $file ) ) {
                ...
                echo __( 'The file does not exist, please try again.', 'ocean-extra' ) . '</p>';
                $this->footer();
                die();
            }
        ...
        public function import_end() {
            ...
            echo '<p>' . __( 'All done.', 'ocean-extra' ) . ' <a href="' . admin_url() . '">' . __( 'Have fun!', 'ocean-extra' ) . '</a>' . '</p>';
            echo '<p>' . __( 'Remember to update the passwords and roles of imported users.', 'ocean-extra' ) . '</p>';
    ...
    <?php endif; ?>
        ...
        public function author_select( $n, $author ) {
            ...
            if ( $create_users ) {
                ...
                if ( '1.0' != $this->version ) {
                    _e( 'or create new user with login name:', 'ocean-extra' );
                    $value = '';
                } else {
                    _e( 'as a new user:', 'ocean-extra' );
            ...
            if ( ! $create_users && '1.0' == $this->version ) {
                _e( 'assign posts to an existing user:', 'ocean-extra' );
            } else {
                _e( 'or assign posts to an existing user:', 'ocean-extra' );
            }
            echo '</label>';
            ...
            echo ' ' . wp_dropdown_users(
                array(
                    ...
                    'multi'           => true,
                    'show_option_all' => __( '- Select -', 'ocean-extra' ),
        ...
        public function process_menu_item( $item ) {
            ...
            if ( ! $menu_slug ) {
                _e( 'Menu item skipped due to missing menu slug', 'ocean-extra' );
                echo '<br />';
                return;
            }
        ...
        public function process_attachment( $post, $url ) {
            if ( ! $this->fetch_attachments ) {
                return new WP_Error(
                    ...
                    __( 'Fetching attachments is not enabled', 'ocean-extra' )
                );
            }
            ...
            if ( $info ) {
                ...
                return new WP_Error( 'attachment_processing_error', __( 'Invalid file type', 'ocean-extra' ) );
            }
        ...
        public function fetch_remote_file( $url, $post ) {
            ...
            if ( ! $tmp_file_name ) {
                return new WP_Error( 'import_no_file', __( 'Could not create temporary file.', 'ocean-extra' ) );
            }
            ...
            if ( is_wp_error( $remote_response ) ) {
                ...
                return new WP_Error(
                    ...
                    sprintf(
                        ...
                        __( 'Request failed due to an error: %1$s (%2$s)', 'ocean-extra' ),
            ...
            if ( 200 !== $remote_response_code ) {
                ...
                return new WP_Error(
                    ...
                    sprintf(
                        ...
                        __( 'Remote server returned the following unexpected result: %1$s (%2$s)', 'ocean-extra' ),
            ...
            if ( ( ! $type || ! $ext ) && ! current_user_can( 'unfiltered_upload' ) ) {
                return new WP_Error( 'import_file_error', __( 'Sorry, this file type is not permitted for security reasons.', 'ocean-extra' ) );
            }
        ...
        public function header() {
            echo '<div class="wrap">';
            echo '<h2>' . __( 'Import WordPress', 'ocean-extra' ) . '</h2>';
        ...
        public function greet() {
            ...
            echo '<p>' . __( 'Howdy! Upload your WordPress eXtended RSS (WXR) file and we&#8217;ll import the posts, pages, comments, custom fields, categories, and tags into this site.', 'ocean-extra' ) . '</p>';
            echo '<p>' . __( 'Choose a WXR (.xml) file to upload, then click Upload file and import.', 'ocean-extra' ) . '</p>';
