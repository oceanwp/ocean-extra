...
var _svg = require("./svg"); // document.addEventListener("DOMContentLoaded", function () {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function addLastItemClassToSectionGroups() {
    var sectionGroups = ['section-core-group', 'section-layout-group', 'section-header-group', 'section-blog-group', 'section-sidebar-group', 'section-footer-group', 'section-perf-group', 'section-free-group', 'section-pro-group', 'section-ecom-group', 'section-lms-group', 'section-extra-group'];
